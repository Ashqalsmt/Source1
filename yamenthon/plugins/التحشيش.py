...
async def permalink(mention):
    ...
    ignored_titles = ["مطور", "المطور", "مالك", "المالك", "مشرف", "ورع","ادمن","جلب","مرتي","تاج","بكلبي",","قرد","مطي","زوجي","زاحف",","فرخ","حاته","هايشة","صاك",","ايجة","كواد","بقلبي","مميز","منشئ",","وصخ","زواج",","حمار","مزه","خروف","حيوان","بزون","زباله","مدير","مرتبط","مرتبطه","حبيبي","خطيبتي","صاكه","حات","جريذي","قلبي","بكلبي"]
