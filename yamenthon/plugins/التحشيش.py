...
async def permalink(mention):
    ...
    ignored_titles = ["مطور", "المطور", "مالك", "المالك", "مشرف", "ورع","ادمن","جلب","مرتي","تاج","بكلبي","فؤادي","قرد","مطي","زوجي","زاحف","كحبه","فرخ","حاته","هايشة","صاك","زبال","ايجة","كواد","ديوث","مميز","منشئ","منجب","وصخ","زواج","طلاك","حمار","مزه","خروف","حيوان","بزون","زباله","مدير","مرتبط","مرتبطه","حبيبي","خطيبتي","صاكه","حات","جريذي","قلبي","بكلبي"]
