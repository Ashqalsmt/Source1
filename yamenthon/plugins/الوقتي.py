    ...
    while AUTOBIOSTART:
        ...
        for normal in HM:
            if normal in normzltext:
              ...
              namefont = namerzfont[normzltext.index(normal)]
              HM = HM.replace(normal, namefont)
        DEFAULTUSERBIO = gvarstatus("DEFAULT_BIO") or "الحمد الله على كل شئ - @yamen"
...
async def _(event):
    ...
    if gvarstatus("digitalpic") is not None and gvarstatus("digitalpic") == "true":
        return await edit_delete(event, "**    ⃟⁞⃟⟢ ╎البروفـايل الوقتـي .. تم تفعيلهـا سابقـاً**")
    addgvar("digitalpic", True)
    await edit_delete(event, "**    ⃟⁞⃟⟢ ╎تـم بـدء البروفـايل الوقتـي .. بنجـاح ✓**")
...
async def _(event):
    if gvarstatus("autoname") is not None and gvarstatus("autoname") == "true":
        return await edit_delete(event, "**    ⃟⁞⃟⟢ ╎الاسـم الوقتـي .. تم تفعيلـه سابقـاً**")
    addgvar("autoname", True)
    await edit_delete(event, "**    ⃟⁞⃟⟢ ╎تـم بـدء الاسـم الوقتـي .. بنجـاح ✓**")
    await autoname_loop()
...
async def _(event):
    ...
    if gvarstatus("autobio") is not None and gvarstatus("autobio") == "true":
        return await edit_delete(event, "**    ⃟⁞⃟⟢ ╎النبـذه الوقتـيه .. مفعلـه سابقـاً**")
    addgvar("autobio", True)
    await edit_delete(event, "**    ⃟⁞⃟⟢ ╎تـم بـدء الـنبذة الوقتيـه .. بنجـاح ✓**")
    await autobio_loop()
...
async def _(event):  # sourcery no-metrics
    ...
    if input_str == "البروفايل تلقائي" or input_str == "البروفايل" or input_str == "البروفايل التلقائي" or input_str == "الصوره الوقتيه" or input_str == "الصورة الوقتية":
        if gvarstatus("digitalpic") is not None and gvarstatus("digitalpic") == "true":
            ...
            return await edit_delete(event, "**    ⃟⁞⃟⟢ ╎تم إيقـاف البروفـايل الوقتـي .. بنجـاح ✓**")
        return await edit_delete(event, "**    ⃟⁞⃟⟢ ╎البروفـايل الوقتـي .. غيـر مفعـل اصـلاً ؟!**")
    if input_str == "الاسم تلقائي" or input_str == "الاسم" or input_str == "الاسم التلقائي" or input_str == "الاسم الوقتي" or input_str == "اسم الوقتي":
        if gvarstatus("autoname") is not None and gvarstatus("autoname") == "true":
            ...
            return await edit_delete(event, "**    ⃟⁞⃟⟢ ╎تم إيقـاف الاسـم الوقتـي .. بنجـاح ✓**")
        return await edit_delete(event, "**    ⃟⁞⃟⟢ ╎الاسـم الوقتـي .. غيـر مفعـل اصـلاً ؟!**")
    if input_str == "البايو تلقائي" or input_str == "البايو" or input_str == "البايو التلقائي" or input_str == "البايو الوقتي" or input_str == "النبذه الوقتيه" or input_str == "النبذة الوقتية" or input_str == "بايو الوقتي" or input_str == "نبذه الوقتي":
        if gvarstatus("autobio") is not None and gvarstatus("autobio") == "true":
            ...
            return await edit_delete(event, "**    ⃟⁞⃟⟢ ╎تم إيقـاف النبـذه الوقتيـه .. بنجـاح ✓**")
        return await edit_delete(event, "**    ⃟⁞⃟⟢ ╎النبـذه الوقتيـه .. غيـر مفعـله اصـلاً ؟!**")
