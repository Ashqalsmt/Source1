...
ZelzalDV_cmd = (
    "𓆩 [𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉✹-اوامر حالات الحساب](t.me/YamenThon) 𓆪\n\n"
    "**⪼** .نائم\n"
...
"**⪼** 💎تحديثات سورس يمنثون القادمة افضل 𐇮\n"
    "\n𓆩 [𐇮 𝗦𝗢𝗨𝗥𝗖𝗘 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉  𐇮](t.me/YamenThon) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت يمنثون انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت يمنثون انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
