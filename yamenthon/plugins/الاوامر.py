...
async def zed_handler(event):
    ...
    if query.startswith("الاوامر") and event.query.user_id == zedub.uid:
        ZEDPIC = (
            gvarstatus("CMD_PIC") or "https://i.postimg.cc/rpCmq92k/image.jpg"
        )
        buttons = [
            [
...
async def zed(event):
    await edit_or_reply(
        event,
        "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙔𝘼𝙈   ⃟⁞⃟⟢ - اوامــر الـخدمــات العـامــه](t.me/YamenThon) 𓆪\n\n**⎞𝟏⎝** `.التخصيص`\n\n**⎞𝟐⎝** `.الترحيب`\n\n**⎞𝟑⎝** `.الردود`\n\n**⎞𝟒⎝** `.الاذاعه`\n\n**⎞𝟓⎝** `.النشر`\n\n**⎞𝟔⎝** `.الكاشف`\n\n**⎞𝟕⎝** `.المساعد`\n\n**⎞𝟖⎝** `.الطقس`\n\n\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙔𝘼𝙈   ⃟⁞⃟⟢](t.me/YamenThon) 𓆪",
    )
...
async def zed(event):
    await edit_or_reply(
        event,
        "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙔𝘼𝙈   ⃟⁞⃟⟢ - قائمــة اوامــر التسـليــه 🏂](t.me/YamenThon) 𓆪\n\n**⎞𝟏⎝** `.تسليه` / `.تسليه1`\n**⎞𝟐⎝** `.تسليه2`\n**⎞𝟑⎝** `.تسليه3`\n**⎞𝟒⎝** `.تسليه4`\n**⎞𝟓⎝** `.تسليه5`\n**⎞𝟔⎝** `.تسليه6`\n**⎞𝟕⎝** `.تسليه7`\n**⎞𝟖⎝** `.تسليه8`\n**⎞𝟗⎝** `.تسليه9`\n**⎞𝟏𝟎⎝** `.تسليه10`\n\n**✾╎قائـمه اوامــر التسـليـه الجـديـده حقـوق سـورس يـــمنثون :**\n\n**⎞𝟏𝟏⎝** `.حيوان` بالـرد\n\n**⎞𝟏𝟐⎝** `.زاحف` بالـرد\n\n**⎞𝟏𝟑⎝** `.مشهور` بالـرد\n\n**⎞𝟏𝟒⎝** `.مشهوره` بالـرد\n\n**⎞𝟏𝟓⎝** `.التحشيش`\n\n**⎞𝟏𝟔⎝** `.معاني` + اسـم\n\n\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙔𝘼𝙈   ⃟⁞⃟⟢](t.me/YamenThon) 𓆪",
    )
...
async def zed_handler(zedub):
    text = "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙔𝘼𝙈   ⃟⁞⃟⟢ - اوامــر البـــوت 🦾🤖](t.me/YamenThon) 𓆪\n\n**⎞𝟏⎝** `.اعاده تشغيل`\n\n**⎞𝟐⎝** `.ايقاف البوت`\n\n**⎞𝟑⎝** `.تحديث`\n\n**⎞𝟒⎝** `.تحديث الان`\n\n**⎞𝟓⎝** `.تحديث البوت`\n\n\n**•❐• لعـرض معلومـات السـورس استخـدم امـر** `.سورس`\n**•❐• لعـرض قنـوات السـورس استخـدم امـر** `.يمنثون` \n\n\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙔𝘼𝙈   ⃟⁞⃟⟢](t.me/YamenThon) 𓆪"
...
@check_owner
async def zed_handler(zedub):
    text = "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙔𝘼𝙈   ⃟⁞⃟⟢ - اوامــر الوقتـــي ⌚️](t.me/YamenThon) 𓆪\n\n**⎞𝟏⎝** `.الاسم تلقائي`\n\n**⎞𝟐⎝** `.البايو تلقائي`\n\n**⎞𝟑⎝** `.البروفايل تلقائي` \n\n**⎞𝟒⎝** `.انهاء الاسم` / `.انهاء البايو` / `.انهاء البروفايل`\n\n**⎞𝟓⎝** `.اوامر الوقتي`\n\n\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙔𝘼𝙈   ⃟⁞⃟⟢](t.me/YamenThon) 𓆪"
    zilzal = [[Button.inline("رجــوع", data="ahmed")]]
    await zedub.edit(text, buttons=zilzal)
...
@check_owner
async def zed_handler(zedub):
    text = "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙔𝘼𝙈   ⃟⁞⃟⟢ - اوامــر المجمــوعــه¹](t.me/YamenThon) 𓆪\n\n**⎞𝟏⎝** `.البوتات`\n\n**⎞𝟐⎝** `.قفل البوتات` / `.فتح البوتات`\n\n**⎞𝟑⎝** `.قفل الاضافه` / `.فتح الاضافه`  \n\n**⎞𝟒⎝** `.قفل الدخول` / `.فتح الدخول `\n\n**⎞𝟓⎝** `.قفل الميديا` / `.فتح الميديا `\n\n**⎞𝟔⎝** `.قفل الفشار` / `.فتح الفشار`\n\n**⎞𝟕⎝** `.قفل الفارسيه` / `.فتح الفارسيه`\n\n**⎞𝟖⎝** `.قفل الروابط` / `.فتح الروابط`\n\n**⎞𝟗⎝**`.قفل المعرفات` / `.فتح المعرفات`\n\n**⎞𝟏𝟎⎝** `.قفل الانلاين` / `.فتح الانلاين`\n\n**⎞𝟏𝟏⎝** `.قفل الكل` / `.فتح الكل`\n\n\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙔𝘼𝙈   ⃟⁞⃟⟢](t.me/YamenThon) 𓆪"
    zilzal = [[Button.inline("رجــوع", data="ahmed")]]
    await zedub.edit(text, buttons=zilzal)
...
@check_owner
async def zed_handler(zedub):
    text = "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙔𝘼𝙈   ⃟⁞⃟⟢ - اوامــر الحســاب 🚹](t.me/YamenThon) 𓆪\n\n**⎞𝟏⎝** `.ايدي` / `.ا`\n\n**⎞𝟐⎝** `.الايدي`\n\n**⎞𝟑⎝** `.صورته`\n\n**⎞𝟒⎝** `.اسمه`\n\n**⎞𝟓⎝** `.الاسماء`\n\n**⎞𝟔⎝** `.المعرفات`\n\n**⎞𝟕⎝** `.تخزين الخاص تفعيل`\n\n**⎞𝟖⎝** `.تخزين الكروبات تفعيل`\n\n\n**- اوامــر حمـايــة الخــاص🛡 :**\n\n**⎞𝟗⎝** `.الحمايه تفعيل`\n\n**⎞𝟏𝟎⎝** `.الحمايه تعطيل`\n\n**⎞𝟏𝟏⎝** `.قبول`\n\n**⎞𝟏𝟐⎝** `.رفض`\n\n**⎞𝟏𝟑⎝** `.مرفوض`\n\n**⎞𝟏𝟒⎝** `.المقبولين`\n\n\n**- اوامــر الحظــر - الكتــم - الطــرد 🔕 :**\n\n**⎞𝟏𝟓⎝** `.حظر`  /  `.الغاء حظر`\n\n**⎞𝟏𝟔⎝** `.كتم`  /  `.الغاء كتم`\n\n**⎞𝟏𝟕⎝** `.طرد`\n\n**⎞𝟏𝟖⎝** `.ح عام`\n\n**⎞𝟏𝟗⎝** `.الغاء ح عام`\n\n**⎞𝟐𝟎⎝** `.ك عام`\n\n**⎞𝟐𝟏⎝** `.الغاء ك عام`\n\n**⎞𝟐𝟐⎝** `.ط عام`\n\n\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙔𝘼𝙈   ⃟⁞⃟⟢](t.me/YamenThon) 𓆪"
    zilzal = [[Button.inline("رجــوع", data="ahmed")]]
    await zedub.edit(text, buttons=zilzal)
...
@check_owner
async def zed_handler(zedub):
    text = "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙔𝘼𝙈   ⃟⁞⃟⟢ - اوامــر تحـويـل الصيــغ 💡🎞](t.me/YamenThon) 𓆪\n\n**⎞𝟏⎝** `.ملصق`\n\n**⎞𝟐⎝** `.حزمه`\n\n**⎞𝟑⎝** `.صورته`\n\n**⎞𝟒⎝** `.معلومات الملصق`\n\n**⎞𝟓⎝** `.ملصقات`\n\n**⎞𝟔⎝** `.لملصق`\n\n**⎞𝟕⎝** `.لصوره`\n\n**⎞𝟖⎝** `.لفيد`\n\n**⎞𝟗⎝** `.دائري`\n\n**⎞𝟏𝟎⎝** `.لمتحركة`\n\n**⎞𝟏𝟏⎝** `.حول بصمه`\n\n**⎞𝟏𝟑⎝** `.حول صوت`\n\n**⎞𝟏𝟒⎝** `.لمتحركه`\n\n**⎞𝟏𝟓⎝** `.لمتحرك`\n\n\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙔𝘼𝙈   ⃟⁞⃟⟢](t.me/YamenThon) 𓆪"
    zilzal = [[Button.inline("رجــوع", data="ahmed")]]
    await zedub.edit(text, buttons=zilzal)
...
@check_owner
async def zed_handler(zedub):
    text = "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙔𝘼𝙈   ⃟⁞⃟⟢ - اوامــر الـخدمــات العـامــه](t.me/YamenThon) 𓆪\n\n**⎞𝟏⎝** `.التخصيص`\n\n**⎞𝟐⎝** `.الترحيب`\n\n**⎞𝟑⎝** `.الردود`\n\n**⎞𝟒⎝** `.الاذاعه`\n\n**⎞𝟓⎝** `.النشر`\n\n**⎞𝟔⎝** `.الكاشف`\n\n**⎞𝟕⎝** `.المساعد`\n\n**⎞𝟖⎝** `.الطقس`\n\n\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙔𝘼𝙈   ⃟⁞⃟⟢](t.me/YamenThon) 𓆪"
    zilzal = [[Button.inline("رجــوع", data="back1")]]
    await zedub.edit(text, buttons=zilzal)
...
@check_owner
async def zed_handler(zedub):
    text = "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙔𝘼𝙈   ⃟⁞⃟⟢ - اوامــر الالـعــاب 🎮🎳 ](t.me/YamenThon) 𓆪\n\n**⎞𝟏⎝** `.بلاي` \n**- العــاب الانـلايـن لســورس يـــمنثون 🕹\n\n**⎞𝟐⎝** `.كت`\n**- اسئلـة كـت تـويت ⁉️**\n\n**⎞𝟑⎝** `.احكام`\n**- لعبــة احكــام الشهيــرة ⚖👩🏻‍⚖**\n\n**⎞𝟒⎝** `.عقاب`\n**- لعبــة عقــاب ⛓**\n\n**⎞𝟓⎝** `.اكس او`\n**- لعبــة اكـس او 🧩**\n\n**⎞𝟔⎝** `.نرد`\n**- لعبــة رمـي النــرد 🎲**\n\n**⎞𝟕⎝** `.سهم`\n**- لعبــة رمـي السهــم 🎯**\n\n**⎞𝟖⎝** `.سله`\n**- لعبــة كــرة السلــة 🏀**\n\n**⎞𝟗⎝** `..كرة`\n**- لعبــة كــرة القــدم ⚽️**\n\n**⎞𝟏𝟎⎝** `.حظ`\n**- لعبــة الحــظ 🎰**\n\n**⎞𝟏𝟏⎝** `.خيرني`\n**- لعبــة لـو خيـروك بالصـور ⁉️🌉**\n\n**⎞𝟏𝟐⎝** `.تويت`\n**- لعبــة كـت تـويت بالصـور ⁉️🌁**\n\n\n**- سيتـم اضـافــة المـزيــد من الالعــاب بالتحديثــات الجــايـه 🎭**"
    zilzal = [[Button.inline("رجــوع", data="back1")]]
    await zedub.edit(text, buttons=zilzal)
...
@check_owner
async def zed_handler(zedub):
    text = "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙔𝘼𝙈   ⃟⁞⃟⟢ - اوامــر الستـوريـات 🎆🏖](t.me/YamenThon) 𓆪\n\n**⎞𝟏⎝** `.حالات واتس`\n**- اكثـر مـن 2000 فيديـو حالات واتسـاب قصيـرة 🎬**\n\n**⎞𝟐⎝**`.ستوري انمي`\n**- مقاطـع ستوريـات انمـي قصيـرة 🎞**\n\n**⎞𝟑⎝** `.ادت`\n**- مقاطـع ادت منـوعـة 🎥**\n\n**⎞𝟒⎝** `.رياكشن`\n**- مقاطـع رياكشـن ترفيهيــه 📺**\n\n**⎞𝟓⎝** `.ميمز`\n**- بصمـات ميمـز تحشيـش 🎃**\n\n**⎞𝟔⎝** `.غنيلي`\n**- مقاطـع اغـانـي قصيـره 🎶**\n\n**⎞𝟕⎝** `.شعر`\n**- مقاطـع صـوت شعـريـه 🎙**\n\n**⎞𝟖⎝** `.رقيه`\n**- رقيـه شرعيـة لعـدة مشائـخ 🕋**\n\n\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙔𝘼𝙈   ⃟⁞⃟⟢](t.me/YamenThon) 𓆪"
    zilzal = [[Button.inline("رجــوع", data="back1")]]
    await zedub.edit(text, buttons=zilzal)
...
@check_owner
async def zed_handler(zedub):
    text = "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙔𝘼𝙈   ⃟⁞⃟⟢ - اوامــر الآفتـــارات والصــور 🎆🏖](t.me/YamenThon) 𓆪\n\n**⎞𝟏⎝** `.ولد انمي`\n**- اكثـر مـن 2500 آفتـار آنمـي شبـاب 🙋🏻‍♂🎆**\n\n**⎞𝟐⎝**`.بنت انمي`\n**- اكثـر مـن 1800 آفتـار آنمـي بنـات 🙋🏻‍♀🎆**\n\n**⎞𝟑⎝** `.رمادي`\n**- آفتـارات شبـاب رمـاديـه 🏂🏙**\n\n**⎞𝟒⎝** `.رماديه`\n**- آفتـارات بنـات رمـاديـه ⛹🏻‍♀🌁**\n\n**⎞𝟓⎝** `.بيست`\n**- آفتـارات بيست تطقيـم بنـات 👯‍♀🏖**\n\n**⎞𝟔⎝** `.حب`\n**- آفتـارات بيست تطقيـم حب ♥️🧚‍♂🧚‍♀**\n\n**⎞𝟕⎝** `.ري اكشن`\n**- صـور رياكشـن تحشيـش 🎃😹**\n\n**⎞𝟖⎝** `.معلومه`\n**- صـوره ومعلومـه معلومـات عـامـه 🗺**\n\n\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙔𝘼𝙈   ⃟⁞⃟⟢](t.me/YamenThon) 𓆪"
    zilzal = [[Button.inline("رجــوع", data="back1")]]
    await zedub.edit(text, buttons=zilzal)
...
async def zed_handler(event):
    ...
    if query.startswith("يمنثون") and event.query.user_id == zedub.uid:
        ZPIC = (
            ...
            or "https://i.postimg.cc/rpCmq92k/image.jpg"
        )
        buttons = [
            [
            ...
            [
                Button.url("التحـديثـات", "https://t.me/YamenThon"),
                Button.url("قناة تداولات المطور", "https://t.me/Q_A_VI"),
            ],
            [
                Button.url("الشـروحـات", "https://t.me/YamenThon1"),
            ],
            [
...
async def zed_handler(event):
    ...
    if query.startswith("سورس") and event.query.user_id == zedub.uid:
        ...
        buttons = [
            [
                Button.url("قنـاة الســورس", "https://t.me/YamenThon"),
                Button.url("مطـور الســورس", "https://t.me/T_A_Tl"),
            ]
        ]
